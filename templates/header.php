        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/public/my_loans.php">Minu
                            laenutused</a></li>
                    <?php endif; ?>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/auth/register.php">Registreeru</a>
                    </li>
                    <?php else: ?>
                    <li class="nav-item"><span class="navbar-text me-2">Tere,
                            <?= sanitize($_SESSION['firstname'] ?? '') ?>!</span></li>
                    <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/public/logout.php">Logi välja</a>
                    </li>
                    <?php endif; ?>
                </ul>
            </div>
